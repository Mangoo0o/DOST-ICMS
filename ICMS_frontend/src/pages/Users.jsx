...
const AddUserModal = ({ isOpen, onClose, onAdd }) => {
  ...
  const validateForm = () => {
    ...
    // Password is auto-generated by backend; no local validation
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Password fields removed; backend will email a temporary password */}
          <div>
        ...
        <ConfirmationModal
          ...
          message={`Are you sure you want to create a new user with the following details?\n\nName: ${formData.firstName} ${formData.lastName}\nEmail: ${formData.email}\nUser Level: ${formData.userLevel}`}
          type="info"
...
const Users = () => {
  ...
  const addUser = async (newUser) => {
    try {
      ...
      if (response.data) {
        // Check if admin was deactivated (current user should logout)
        if (response.data.admin_deactivated) {
          console.log('Admin deactivated, logging out current user');
          
          // Show notification about admin deactivation
          toast.success('New admin created successfully! You have been logged out as the previous admin.', {
            duration: 6000,
            position: 'top-center',
            style: {
              background: '#10B981',
  ...
  return (
    <div className="p-6 bg-gray-100 h-full">
      ...
      <ConfirmationModal
        ...
        title="Edit User"
        message={`Are you sure you want to edit user "${userToAction?.fullname}"?`}
        type="info"
        confirmText="Edit"
        cancelText="Cancel"
      />
