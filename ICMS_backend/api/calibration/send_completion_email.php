    ...
    try {
        ...
        $sampleDetails = [
            ...
            'calibrated_by' => !empty($sampleData['calibrator_first_name']) && !empty($sampleData['calibrator_last_name']) 
                ...
                // Send calibration completion email
                $emailService->sendCalibrationCompletionEmail(
                ...
                error_log('Failed to send calibration completion email: ' . $e->getMessage());
            }
        }
        
        echo json_encode([
            'message' => 'Calibration completion notification processed',
        ...
        echo json_encode(['message' => 'Failed to process calibration completion notification: ' . $e->getMessage()]);
    }
} else {
